        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              iCourt 第二届全国法律人 AI 应用大赛 律所赛道二等奖 ·
            ...
            >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-indigo-500 rounded-xl font-semibold text-indigo-600 hover:bg-indigo-50 transition-all"
              >
                查看项目
              </motion.a>
              <motion.a
